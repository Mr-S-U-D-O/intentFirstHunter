                                    ...
                                    <div key={scraper.id}>
                                      <Tooltip>
                                        ...
                                        <TooltipContent side="right" className="max-w-[200px] break-words">
                                          <p className="font-bold text-xs mb-1">{scraper.name}</p>
                                          <p className="text-[10px] opacity-80">Target: {scraper.target || scraper.subreddit}</p>
                                          <p className="text-[10px] opacity-80">Keywords: {scraper.keyword}</p>
                                        </TooltipContent>
                                      </Tooltip>
                                    </div>
                                  )
